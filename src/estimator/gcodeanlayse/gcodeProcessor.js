...
function GcodeProcessor() {
    this.results = {
        "Category0": { "description": "Time", "table": "gcodeStats" },
        "printTime": { "description": "Print Time", "table": "gcodeStats" },
        "accelerationTime": { "description": "Time Spent Accelerating/Decelerating", "table": "gcodeStats" },
        "constantSpeedTime": { "description": "Time Spent at Target Speed", "table": "gcodeStats" },
        "zHopTime": { "description": "Total Z Hop Time", "table": "gcodeStats" },
        "retractTime": { "description": "Total Retract/Prime Time", "table": "gcodeStats" },
        "Category1": { "description": "Distance", "table": "gcodeStats" },
        "totalDistance": { "description": "Total Distance Moved", "table": "gcodeStats" },
        "printDistance": { "description": "Print / Travel Move Distance", "table": "gcodeStats" },
        "accelerationDistance": { "description": "Distance Accelerating/Decelerating", "table": "gcodeStats" },
        "constantSpeedDistance": { "description": "Distance at Target Speed", "table": "gcodeStats" },
        "filamentUsage": { "description": "Raw Filament Usage", "table": "gcodeStats" },
        "filamentLineRatio": { "description": "Printed Line Length per mm of Raw Filament", "table": "gcodeStats" },
        "Category2": { "description": "Speed", "table": "gcodeStats" },
        "averageSpeed": { "description": "Average Speed", "table": "gcodeStats" },
        "printSpeed": { "description": "Average Print Speed", "table": "gcodeStats" },
        "travelSpeed": { "description": "Average Travel Speed", "table": "gcodeStats" },
        "filamentUsageRate": { "description": "Raw Filament Usage Rate", "table": "gcodeStats" },
        "xyFeedrate": { "description": "Min / Max XY Feedrate", "table": "gcodeStats" },
        "Category3": { "description": "Count", "table": "gcodeStats" },
        "numberOfLines": { "description": "Number of Lines", "table": "gcodeStats" },
        "moveCommandCount": { "description": "Total Move Commands (G0 & G1)", "table": "gcodeStats" },
        "reachTargetSpeedCount": { "description": "Move Commands Reached Target Speed", "table": "gcodeStats" },
        "moveType": { "description": "Print Move / Travel Move", "table": "gcodeStats" },
        "zHopCount": { "description": "Z Hop Count", "table": "gcodeStats" },
        "retractCount": { "description": "Retraction Count", "table": "gcodeStats" },
        "limitedMaxSpeedPerAxis": { "description": "Times Move Speed Limited By Axis Max Speed", "table": "gcodeStatsPerAxis", "fieldId": ["limitedMaxSpeedX", "limitedMaxSpeedY", "limitedMaxSpeedZ", "limitedMaxSpeedE"] },
        "totalDistancePerAxis": { "description": "Total Distance Moved", "table": "gcodeStatsPerAxis", "fieldId": ["totalDistanceX", "totalDistanceY", "totalDistanceZ", "totalDistanceE"] },
        "averageSpeedPerAxis": { "description": "Average Speed", "table": "gcodeStatsPerAxis", "fieldId": ["averageSpeedX", "averageSpeedY", "averageSpeedZ", "averageSpeedE"] }
    }
    ...
    this.processGcodes = function (gcodeLines, settings) {
        ...
        parentPort.postMessage({ "histogram": this.STHistogram });
        ...
        parentPort.postMessage({ "layers": { "layers": layers, "maxSpeed": maxPrintingSpeed, "maxCoord": maxCoord, "minCoord": minCoord, "maxFanSpeed": this.maxFanSpeed } });
        layers = undefined;
        layerMaxs = undefined;
        layerMins = undefined;
    }
...
const { gcodeLines, settings } = workerData;
